...
Se você pretnde organizar um evento rails Girls comece preenchendo e enviando o formulário existe em [http://railsgirls.com/inyourcity](http://railsgirls.com/inyourcity) e nós enviaremos para você instruções sobre a organização do evento. 

Uma listagem dos próximos eventos programados pode ser vista em [www.railsgirls.com](http://railsgirls.com).

Você está convidado a se engajar em nosso fórum de discussões em [organizers' Slack discussion forum](https://rails-girls-slack.herokuapp.com/).

### Princípios fundamentais

Os eventos Rails Girls não têm fins lucrativos. Nós não cobramos ingresso dos participantes e nem remuneramos os coachs e palestrantes. Não existe qualquer restrição relativa a requisitos básicos e conhecimentos, bem como não há limitações quanto a idade dos participantes. Tudo o que é necessário para participar limita-se a um laptop e uma boa dose de curiosidade.
...
* A Internet foi criada por humanos (e não vai ser destruida por pequenos ajustes ???) it doesn’t break by a little tinkering. Enfatizar continuamente o lado humano: os coaches são incentivados a falar sobre as comunidades de código aberto, seus ídolos e onde eles, coaches, buscam inspiração para seu trabalho.
...
Eventos Rails Girls são realizados em um ambiente inclusivo, amigável e seguro. Nos eventos a tolerância para assédio ou buling é zero. Você pode criar um código de conduta para seu evento. A seguir uma lista de links com exemplos de alguns códigos de conduta:
...
### Examplo de programa para o evento
