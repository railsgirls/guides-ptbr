...
**Instrutor(a):** Fale sobre os benefícios do uso da plataforma Heroku para publicação vs uso de servidores tradicionais.
...
**Instrutor(a):** Você pode falar sobre RDBMS e as diferenças para outros sistemas de gerenciamento bem como apresentar alguns detalhes das dependências em Heroku no PostgreSQL.
...
**Instrutor(a):** Agora é uma ótima oportunidade para falar sobre sistemas de controle de versão e git.
