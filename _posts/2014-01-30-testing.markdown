...
__COACH__: Fale sobre 'goglear' a saída do terminal
...
__COACH__: Fale um pouco sobre a refatoração.
...
__COACH__: Fale um pouco sobre Desenvolvimento Guiado por Comportamento (BDD).
