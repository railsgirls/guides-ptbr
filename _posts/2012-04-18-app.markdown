...
Abra <http://localhost:3000> no navegador. Se você estiver usando um serviço na nuvem (por exemplo: nitrous), use a funcionalidade preview do serviço (ver [guia de instalação](/install#using-a-cloud-service) para detalhes).
