...
Você pode alterar o HTML e CSS ainda mais, adicionando regras de estilização ao arquivo `app/assets/stylesheets/application.css`.
...
Se um erro for mostrado, falando que o uploader não pode ser encontrado, adicione também a seguinte linha:
{% highlight ruby %}
gem 'net-ssh'
{% endhighlight %}
