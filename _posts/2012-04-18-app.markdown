...
Note que nesta nova janela o prompt de comando não é visível, pois você se encontra no servidor Rails.

O prompt de comando deve parecer com isso:
...
## *6.* Criando uma página estática na sua app
